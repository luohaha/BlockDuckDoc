...
* [Introduce](README.md)
* [Why BlockDuck](blockduck/why-blockduck.md)

## Getting Started

* [Quickstart](getting-started/quickstart.md)
* [How to build](getting-started/publish-your-docs.md)
* [Try your first query](getting-started/try-your-first-query.md)
* [Supported Blockchains](getting-started/supported-blockchains.md)

## Functionality

* [Basic EVM structure table function](functionality/basic-evm-structure-table-function/README.md)
  * [Blocks](functionality/basic-evm-structure-table-function/blocks.md)
...
* [Customized EVM contact table function](functionality/customized-evm-contact-table-function/README.md)
  * [Contract Events](functionality/customized-evm-contact-table-function/contract-events.md)
  * [Contract view function](functionality/customized-evm-contact-table-function/contract-view-function.md)
...
* [Types Mapping between DuckDB and EVM](types/types-mapping-between-duckdb-and-evm.md)

## Examples

* [Python examples](examples/python-examples/README.md)
  * [Hourly ERC20 transfer volumn monitor page](examples/python-examples/hourly-erc20-transfer-volumn-monitor-page.md)
